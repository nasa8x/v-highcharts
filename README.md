...
#About
Highcharts component for Vue.js version >= 2.0
...
<template>
    <div class="container">
        <highcharts type="default" height="600px" :options="options"></highcharts>
    </div>
</template>
...
<template>
    <div class="container">
        <highcharts type="stock" height="600px" :options="options"></highcharts>
    </div>
</template>
...
<template>
    <div class="container">
       <highcharts type="maps" height="600px" :options="options"></highcharts>
    </div>
</template>
